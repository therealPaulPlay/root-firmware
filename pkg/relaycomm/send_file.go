...
// SendFileInChunksAsync reads a file and sends it in chunks
func SendFileInChunksAsync(ctx *HandlerContext, msgType string, filePath string, fileType string, metadata map[string]any, onComplete func()) {
	go func() {
